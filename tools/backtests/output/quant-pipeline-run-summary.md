...
> Généré le 2026-05-18T10:33:47.395Z par `tools/backtests/run-quant-pipeline-v1.mjs`.
...
|---:|---|---|---:|---|---|
| 1 | asset-quality-engine-v1 | ✓ OK | 888 ms | `tools/backtests/output/asset-quality-report.json` | ✓ |
| 2 | asset-setup-matrix-v1 | ✓ OK | 929 ms | `tools/backtests/output/asset-setup-matrix.json` | ✓ |
| 3 | setup-variant-matrix-v1 | ✓ OK | 1.0 s | `tools/backtests/output/setup-variant-matrix.json` | ✓ |
| 4 | variant-regime-matrix-v1 | ✓ OK | 1.6 s | `tools/backtests/output/variant-regime-matrix.json` | ✓ |
| 5 | walk-forward-regime-validator-v1 | ✓ OK | 1.2 s | `tools/backtests/output/walk-forward-regime-validator.json` | ✓ |
| 6 | tradable-universe-v1 | ✓ OK | 752 ms | `tools/backtests/output/tradable-universe.json` | ✓ |
| 7 | allocation-engine-v1 | ✓ OK | 164 ms | `tools/backtests/output/allocation-plan.json` | ✓ |
