(() => {
  ...
  function compactError(message) {
    ...
    if (!msg) return null;
    if (msg.includes("Too many subrequests by single Worker invocation")) return "Limite Cloudflare atteinte";
    if (msg.includes("apiKey plan")) return "Limite fournisseur";
